...
<body>
	...
	<section>
		<h1>Imagenes Eventos</h1>
		<article id="automargen">
			<form action="#" method="post" enctype="multipart/form-data" id="evet_image" class="columninput">
				<label>Del evento</label>
				<select id="evid" name="evid">
					<option value="0">Seleccione</option>
					<?php
						$Tevest="SELECT * from eventos order by nam_evet asc";
						$sql_Tece=mysql_query($Tevest,$conexion) or die (mysql_error());
						while ($tv=mysql_fetch_array($sql_Tece)) {
							$idevet=$tv['id_evet'];
							$nmevet=$tv['nam_evet'];
					?>
					<option value="<?php echo $idevet ?>"><?php echo "$nmevet"; ?></option>
					<?php
						}
					?>
				</select>
