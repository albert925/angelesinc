<?php
	...
	if (isset($_SESSION['adm'])) {
		...
		if ($idR=="") {
			...
			$dato="SELECT * from eventos where id_evet='$idR'";
			$sql_dato=mysql_query($dato,$conexion) or die (mysql_error());
	...
	<section>
		...
		<article id="automargen">
			<article class="columninput">
				<label>Nombre</label>
				<input type="text" id="nmeFvet" value="<?php echo $nmE ?>" required="required" />
				<label>Descripción</label>
				<textarea id="txeFvet"><?php echo "$txtE"; ?></textarea>
				<div id="txC"></div>
				<input type="submit" value="Modificar" id="fmfevet" class="botonstyle" data-id="<?php echo $idR ?>" />
			</article>
		</article>
	</section>
	<footer>
