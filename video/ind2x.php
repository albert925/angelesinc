<?php
	...
	if ($idR=="") {
		echo "<script type='text/javascript'>";
			...
			echo "var pagina='../video';";
			echo "document.location.href=pagina;";
		echo "</script>";
	}
	else{
		$vidN="SELECT * from videos where id_video=$idR";
		$sql_viN=mysql_query($vidN,$conexion) or die (mysql_error());
		while ($Os=mysql_fetch_array($sql_viN)) {
			$nomVideo=$Os['nam_vid'];
		}
?>
<!DOCTYPE html>
...
<body>
	...
	<nav id="mnP">
		...
		<a href="../video" class="selB">Videos</a>
	...
	<section id="automargen">
		<h2 id="hdos"><?php echo "$nomVideo"; ?></h2>
		<article class="fleaxtDlx">
			...
			?>
			<article>
				<iframe width="100%" height="315" src="https:<?php echo $rutV ?>" frameborder="0" allowfullscreen></iframe>
			</article>
			<?php
				}
			?>
		...
		<article>
			...
			?>
						<a href="ind2x.php?vd=<?php echo $idR ?>&pagina=<?php echo $i ?>"><?php echo "$i"; ?></a>
