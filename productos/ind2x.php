...
<body>
	...
	<section>
		...
		<article id="filtros">
			<select id="orD" data-tp="<?php echo $tipoRRR ?>">
				<?php
					for ($dro=0; $dro <=4 ; $dro++) { 
						switch ($dro) {
							case '0':
			...
			<select id="pTP" data-tp="<?php echo $tipoRRR ?>">
			...
			<select id="pMK" data-tp="<?php echo $tipoRRR ?>">
			...
			?>
			<input type="range" id="preciorangi" min="<?php echo $mi ?>" max="<?php echo $ma ?>" step="2" value="<?php echo $mi ?>" data-tp="<?php echo $tipoRRR ?>" />
			<input type="range" id="preciorangx" min="<?php echo $mi ?>" max="<?php echo $ma ?>" step="2" value="<?php echo $ma ?>" data-tp="<?php echo $tipoRRR ?>" />
			<?php
				if ($tipus!="1") {
			?>
		...
		<article id="nw_produ">
			...
			<article id="prdonw">
				<?php
						...
						$ssql="SELECT * from producto where cl_id='$tipoRRR' order by precN_p asc";
				...
				<article class="flexartclC">
					<?php
						$gsql="SELECT * from producto where cl_id='$tipoRRR' order by precN_p asc limit $inicio, $tamno_pagina";
